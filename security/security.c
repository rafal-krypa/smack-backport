			...
			unsigned long addr, unsigned long addr_only)
{
	...
	ret = call_int_hook(file_mmap, 0, file, reqprot, prot,
...
struct security_hook_heads security_hook_heads = {
	...
	.file_mmap =	LIST_HEAD_INIT(security_hook_heads.file_mmap),
	.file_mprotect =
	...
	.dentry_open =	LIST_HEAD_INIT(security_hook_heads.dentry_open),
	...
	.tun_dev_post_create =
		LIST_HEAD_INIT(security_hook_heads.tun_dev_post_create),
	.tun_dev_attach =
	...
	.xfrm_state_alloc_security =
		LIST_HEAD_INIT(security_hook_heads.xfrm_state_alloc_security),
